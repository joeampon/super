...
class Grinder(bst.Unit):
    ...
    def _design(self):
        ...
        # Find the grinder energy requirement for polystyrene
        # Grinder_electricity = 300 * self.ins[0].get_total_flow("tonnes/hr") # 300kwh/tonne   Gracida alvarez et al. 2019 
        Grinder_electricity = 50 * self.ins[0].get_total_flow("tonnes/hr") # 300kwh/tonne   Gracida alvarez et al. 2019 
        
        self.design_results['Grinder_feed'] = self.ins[0].get_flow("tonnes/day","PS")
